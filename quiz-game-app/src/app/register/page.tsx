  ...
  return (
    <main className='container flex w-screen h-screen'>
      ...
      <div className='right flex flex-col items-center justify-center w-1/2 h-full'>
        <Link href='/login' className='text-white text-sm text-center font-medium py-1 bg-[#8663AA] w-32 rounded-t-lg opacity-70 cursor-pointer transition-all ease-in-out hover:opacity-100'>
          <span>Login</span>
        </Link>
        <div className='modal w-4/6 h-4/5 rounded-xl bg-white'>
          ...
          <div className="modal-body flex justify-center">
            <form className="w-9/12 flex center flex-col mt-2">
              ...
              <svg onClick={() => API.register(userData)} className='mt-2 w-14 self-center cursor-pointer transition-all ease-in-out hover:ml-5' width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className='text-center text-sm font-medium'>To complete</p>
            </form>
          </div>
        </div>
      </div>
