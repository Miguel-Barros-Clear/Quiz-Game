        ...
        <div className='modal w-4/6 h-3/6 rounded-xl bg-white'>
          ...
          <div className="modal-body flex justify-center">
            <form className="w-9/12 flex center flex-col mt-2">
              ...
              <svg className='mt-1 w-14 self-center cursor-pointer transition-all ease-in-out hover:ml-5' width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
